											...
											<div className="col-md-6 col-lg-2">
												<div className="ftco-footer-widget mb-4">
													...
													<ul className="list-unstyled">
														<li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Properties</a></li>
														<li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Agents</a></li>
														<li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Locations</a></li>
														<li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Clients Support</a></li>
													</ul>
												</div>
											</div>
											<div className="col-md-6 col-lg-2">
												<div className="ftco-footer-widget mb-4">
													...
													<ul className="list-unstyled">
														...
														<li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Contact Us</a></li>
													</ul>
												</div>
											</div>
											<div className="col-md-6 col-lg-2">
												<div className="ftco-footer-widget mb-4">
													...
													<ul className="list-unstyled">
														<li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Terms &amp; Conditions</a></li>
														<li><a href="#"><span className="fa fa-chevron-right mr-2"></span>User's Guide</a></li>
														<li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Support Center</a></li>
														<li><a href="#"><span className="fa fa-chevron-right mr-2"></span>Press Info</a></li>
													</ul>
												</div>
											</div>
											<div className="col-md-6 col-lg">
												<div className="ftco-footer-widget mb-4">
													...
													<div className="block-23 mb-3">
														<ul>
															...
															<li><a href="#"><span className="icon fa fa-paper-plane pr-4"></span><span className="text"><span className="__cf_email__" data-cfemail="5831363e371821372d2a3c3735393136763b3735">[email&#160;protected]</span></span></a></li>
														</ul>
													</div>
												</div>
											</div>
